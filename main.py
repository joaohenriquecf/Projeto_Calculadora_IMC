#Alunos: Cauã Cysneiros ; João Henrique Castro
...
def atualizar_dados():
    ...
    with open("dados_imc.txt", "r") as file:
    ...
    with open("dados_imc.txt", "w") as file:
...
b_limpar = Button(frame_down, text='Limpar', width=7, height=1, overrelief=SOLID, padx=0, pady=3, relief='raised', anchor='center', font=('Roboto', 10 , 'bold'), bg=cor2, fg=cor1, command=limpar)
b_limpar.grid(row=4, column=1, columnspan=30, sticky=NSEW, pady=60, padx=5)
b_limpar.place(x=220, y=140)

#Crição do botao para salvar os dados
b_salvar_dados = Button(frame_down, text='Salvar', width=7, height=1, overrelief=SOLID, padx=0, pady=3, relief='raised', anchor='center', font=('Roboto', 10 , 'bold'), bg=cor2, fg=cor1, command=salvar_dados)
b_salvar_dados.grid(row=4, column=1, sticky=NSEW, pady=60, padx=5)
b_salvar_dados.place(x=150, y=140)



# Criação do botão de atualizar dados
b_atualizar_dados = Button(frame_down, text='Atualizar', width=7, height=1, overrelief=SOLID, padx=0, pady=3, relief='raised', anchor='center', font=('Roboto', 10 , 'bold'), bg=cor2, fg=cor1, command=atualizar_dados)
b_atualizar_dados.grid(row=4, column=1, sticky=NSEW, pady=60, padx=5)
b_atualizar_dados.place(x=80, y=140)

# Criação do botão de buscar dados para atualização
b_buscar_dados = Button(frame_down, text='Buscar', width=7, height=1, overrelief=SOLID, padx=0, pady=3, relief='raised', anchor='center', font=('Roboto', 10 , 'bold'), bg=cor2, fg=cor1, command=buscar_dados)
b_buscar_dados.grid(row=4, column=1, sticky=NSEW, pady=60, padx=5)
b_buscar_dados.place(x=10, y=140)
